...
public record StorageProperties(String endpoint, String region, String accessKey, String secretKey, String bucket, String derivedBucket) {

    public StorageProperties {
        for (String[] required : new String[][] {
            {endpoint, "S3_ENDPOINT"}, {accessKey, "S3_ACCESS_KEY"}, {secretKey, "S3_SECRET_KEY"}, {bucket, "S3_BUCKET_RAW"},
            {derivedBucket, "S3_BUCKET_DERIVED"}}) {
